...
const Container = ({
  ...
  return (
    <div className="border-conversation-border border-1 w-full bg-conversation-panel-background flex flex-col overflow-hidden items-center justify-center text-white">
