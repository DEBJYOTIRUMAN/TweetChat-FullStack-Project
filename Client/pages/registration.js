        ...
        <div>
          <section className="bg-gray-900">
            <div className="flex justify-center min-h-screen">
              <div
                className="bg-cover w-2/5 lg:w-1/2 md:hidden"
                style={{
                  backgroundImage: `url(${registerImage.src})`,
                }}
              ></div>

              <div className="flex items-center max-w-3xl mx-auto px-12 w-3/5 lg:p-8 lg:w-1/2 md:flex-1">
                <div className="w-full">
                  ...
                  <div className="grid gap-6 mt-12 grid-cols-2 lg:grid-cols-1">
                    <div>
                      <label
                        htmlFor="firstName"
